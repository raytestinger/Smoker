...
- `analysis/bin/build_61035_configuration_overlay.pl`
- `analysis/bin/build_61035_dependency_overlay.pl`
- `analysis/bin/build_61035_other_failure_overlay.pl`
- `analysis/bin/build_61035_missing_prerequisite_overlay.pl`

Current-tool note (30 August 2026): the builders listed above are now Perl ports. Historical evidence is unchanged. See `Perl_Audit_Builder_Conversion.md` for byte-for-byte comparison results and `../analysis/README.md` for usage.
